...
export default function Chart(props) {
    ...
    React.useEffect(() => {
        ...
        allBooking.forEach((bookingItem) => {
            if (getDate.indexOf(formatDate(bookingItem.create_date)) < 0) {
                getDate.push(formatDate(bookingItem.create_date))
            }
        })
        ...
        getDate.forEach((dateItem) => {
            let price = 0
            allBooking.forEach((bookingItem) => {
                if (formatDate(bookingItem.create_date) === dateItem.toString()) {
