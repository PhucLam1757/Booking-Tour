...
export default function ComponentAdminAddHotel(props) {
    ...
    const addNewTour = async () => {
        try {
            ...
            if (!hotelData.hotel_name || !hotelData.hotel_cate || !hotelData.place_id || !hotelData.hotel_image || !hotelData.hotel_desc) {
                ...
                const addHotelRes = await HotelAPI.addNewHotel(hotelAllData)

                if (addHotelRes.data && addHotelRes.data.success) {
                    setAddHotelNoti({ status: true, noti: 'Thêm thông tin khách sạn thành công', type: 'success' })
                    ...
                    setAddHotelNoti({ status: true, noti: 'Không thể thêm thông tin khách sạn', type: 'error' })
                }
        ...
        <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <Stack spacing={2} justifyContent="space-around" flexDirection={'row'}>
                            <Button variant="contained" sx={{ width: 'fit-content' }} onClick={() => addNewTour()}>Thêm khách sạn</Button>
                        </Stack>
                    </Grid>
                </Grid>
            </Grid>
